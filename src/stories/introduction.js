...
storiesOf("综述", module)
  .add("介绍", () => (
    <article style={{ padding: 20 }} className="index-page">
      ...
      <p>
        <a href="https://www.npmjs.com/package/berry-ui" title="npm">
          <img
            src="https://img.shields.io/npm/dm/berry-ui.svg?style=for-the-badge"
            alt="npm"
          />
        </a>
        {"  "}
        <a href="https://isitmaintained.com/project/berry-ui/berry-ui">
          <img src="https://img.shields.io/github/issues/berry-ui/berry-ui.svg?style=for-the-badge" />
        </a>
        {"  "}
        <a href="https://github.com/berry-ui/berry-ui">
          <img src="https://img.shields.io/github/stars/berry-ui/berry-ui.svg?style=for-the-badge" />
        </a>
      </p>
      ...
      <h2>当前版本</h2>
      <p>
        <a href="https://badge.fury.io/js/berry-ui" title="npm">
          <img
            src="https://img.shields.io/npm/v/berry-ui.svg?style=for-the-badge"
            alt="npm version"
          />
        </a>
      </p>
    ...
    <a href="https://badge.fury.io/js/berry-ui" title="npm">
      <img
        src="https://img.shields.io/npm/v/berry-ui/next.svg?style=for-the-badge"
        alt="npm version"
      />
    </a> */}
      ...
      <p>
        ...
        这个组件库的 宗旨 : 即插即用 其次 berry 谐音 (cool ke) 很酷的李金珂的
      ...
      <h2>贡献</h2>
      <p>
        如果你在使用 <Tag type="primary">berry-ui</Tag> 时遇到了问题,或者想骂我,
        欢迎 给我提
        <a href="https://github.com/berry-ui/berry-ui/issues"> Issue</a> 或{" "}
        <a href="https://github.com/berry-ui/berry-ui/pulls">Pull Request</a>
      </p>
      ...
      <Alert
        ...
        message={
          <span>
            请按照{" "}
            <a href="https://github.com/berry-ui/berry-ui/blob/master/README.md">
              README
            </a>{" "}
            文档使用
          </span>
  ...
  .add("快速上手", () => (
    <ReactMarkDown
      source={require("./markdown/quick_start.md")}
      renderers={{
        CodeBlock,
        Code: CodeBlock
      }}
  ...
  .add(`更新日志`, () => (
    <div className="change-log">
      <ReactMarkDown
        source={require("./markdown/change_log.md")}
        renderers={{
          CodeBlock,
          Code: CodeBlock
        }}
  ...
  .add(`关于berry-ui`, () => (
    <>
      <ReactMarkDown
        source={require("./markdown/berry.md")}
        renderers={{
          CodeBlock,
          Code: CodeBlock
        }}
