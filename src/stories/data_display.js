...
import "../components/tooltip/index.styl";
import "../components/button/index.styl";
import "../components/tab/index.styl";
import "../components/timeline/index.styl";
import "../components/tag/index.styl";
import "../components/city_picker/index.styl";
import "../components/avatar/index.styl";
import "../components/collapse/index.styl";
import "../components/calendar/index.styl";
import "../components/popover/index.styl";
import "../components/popconfirm/index.styl";
import "../components/card/index.styl";
import "../components/empty/index.styl";
import "../components/badge/index.styl";
import "../components/table/index.styl";
import "../components/count_down/index.styl";
import "./styles/data_display.styl";
...
storiesOf("数据展示", module)
  ...
  .add("Avatar 头像", () => (
    <div className="berry-avatar-example">
      <h2>基本使用</h2>
      <div>
