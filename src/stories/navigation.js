...
import "../components/breadcrumb/index.styl";
import "../components/pagination/index.styl";
import "../components/dropdown/index.styl";
import "../components/affix/index.styl";
import "../components/step/index.styl";
import "./styles/navigation.styl";
import StepsPage from "./pages/steps_page";

const overlay = (
  <ul className="example-dropdown-list">
    <li>
      {" "}
      <a href="https://github.com/berry-ui/berry-ui">红烧牛肉</a>
    </li>
    <li>
      {" "}
      <a href="https://github.com/berry-ui/berry-ui">麻辣干锅</a>
    </li>
    <li>
      {" "}
      <a href="https://github.com/berry-ui/berry-ui">子酱肉丝</a>
    </li>
  </ul>
);
