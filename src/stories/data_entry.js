...
import WordPadPage from "./pages/word_pad";
...
import "../components/input/index.styl";
import "../components/radio/index.styl";
import "../components/checkbox/index.styl";
import "../components/select/index.styl";
import "../components/date_picker/index.styl";
import "../components/number_input/index.styl";
import "../components/number_input/index.styl";
import "../components/word_pad/index.styl";
import "../components/upload/index.styl";
import "../components/form/index.styl";
import "../components/switch/index.styl";
import "./styles/data_entry.styl";
...
storiesOf("数据录入", module)
  .add(
    ...
    withInfo(`
      ...
      import WordPad from '../../components/word_pad';
      import Button from '../../components/button';
      import message from '../../components/message';
